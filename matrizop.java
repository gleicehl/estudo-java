...
public class matrizop{
    public static void main(String[] args) {
        ...
        int det1=calcularDeterminante(matriz1);
        int det2= calcularDeterminante(matriz2);

        System.out.println("O Determinante da matriz 1 é: " + det1); 
        System.out.println("O Determinante da matriz 2 é: " + det2); 
